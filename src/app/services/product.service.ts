...
export class ProductService {
  ...
  public getProducts(page : number=1, size:number=4):Observable<HttpResponse<Product[]>>{
    return this.http.get <Product[]>(`http://localhost:8089/products?_page=${page}&_limit=${size}`, { observe: 'response' });
  }
